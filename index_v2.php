...
<head>
    ...
    <style>
        ...
        .operasional { background: #e3f2fd; border-left: 4px solid #2196f3; padding: 12px; margin: 10px 0; }
        strong { color: #34495e; }
    </style>
</head>
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Nailah Dhina Amelia"; ?></p>
            <p><strong>Tanggal:</strong> <?php echo date('d F Y'); ?></p>
            <p><strong>Waktu Server:</strong> <?php echo date('H:i:s'); ?></p>
        </div>

        <?php
        $alamat_perpus  = "Jl. Pendidikan No. 45, Kota Pelajar";
        $telepon_perpus = "(021) 555-1234";
        $jam_buka       = "08.00";
        $jam_tutup      = "16:00";
        ?>
        ...
        // Perhitungan buku tersedia dan persentase
